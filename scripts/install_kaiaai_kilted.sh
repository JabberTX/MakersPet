...
ros-kilted-nav2-map-server ros-kilted-nav2-bringup \
ros-kilted-joint-state-publisher ros-kilted-xacro
...
git clone -b iron --depth 1 https://github.com/kaiaai/kaiaai_bringup src/kaiaai_bringup
